...
<head>
    ...
    <title>Data Pelanggan - TeFa</title>
...
<body class="bg-slate-100 font-sans p-8">
    <div class="max-w-4xl mx-auto bg-white p-6 rounded-xl shadow-md">
        ...
        <div class="flex space-x-4 border-b pb-4 mb-6 text-sm font-medium">
            ...
            <a href="{{ route('pelanggans.index') }}" class="text-blue-600 font-bold border-b-2 border-blue-600 pb-4 -mb-4">Data Pelanggan</a>
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                ...
                <p class="text-slate-500 text-sm">Kelola pelanggan jasa layanan SMKN 1 Katapang</p>
            </div>
            <a href="{{ route('pelanggans.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium">
                + Tambah Pelanggan
            </a>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-slate-100 text-sm text-slate-700">
                    @forelse ($pelanggans as $index => $item)
                        <tr class="hover:bg-slate-50">
                            ...
                            <td class="p-3 text-center">
                                <form action="{{ route('pelanggans.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus?')">
                                    @csrf
                                    @method('DELETE')
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="p-4 text-center text-slate-400">Belum ada data pelanggan.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
